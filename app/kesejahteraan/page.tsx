...
import { ReminderCheck } from '@/components/kesejahteraan/reminder-check'
...
export default function KesejahteraanPage() {
  ...
  return (
    <>
      {/* ReminderCheck di luar MainLayout agar tetap berjalan */}
      <ReminderCheck schedule={schedule} santriList={santriList} />
